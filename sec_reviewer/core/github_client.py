...
class GitHubClient:
    ...
    def get_pr_details_from_event(self) -> PRDetails:
        ...
        try:
            pr_details = self._get_pr_details(owner, repo, pull_number)
    ...
    def _get_pr_details(self, owner: str, repo: str, pull_number: int) -> PRDetails:
    ...
    def _get_pr_with_retry(self, repo: Repository, pull_number: int) -> PullRequest:
    ...
    def _generate_review_summary(self, comments: List[ReviewComment]) -> str:
        ...
        summary_parts = ["🤖 **Agentic Code Sec Review**"]
